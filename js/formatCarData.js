...
function formatCarData(carData) {
    const {
        JavaScriptInfo: { 
            id: carId, 
            cantidadImágenes: imageCount, 


            imágenesModelo: imagesModel,
            imágenesExterior: imagesExterior,
            imágenesInterior: imagesInterior,
        ...
        Equipamiento, // Keep Equipamiento as a whole object
        Multimedia: multimediaFeatures,
        Seguridad: safetyFeatures,
        Otros: otherFeatures
    } = carData;

    // Separate Equipamiento into exterior and interior equipment
    const exteriorEquipment = Equipamiento?.Exterior || [];
    const interiorEquipment = Equipamiento?.Interior || [];
    ...
    return {
        ...
        carDescription,
        Equipamiento,
        exteriorEquipment, // Now separate exterior equipment
        interiorEquipment, // Now separate interior equipment
        multimediaFeatures,
        safetyFeatures,
        otherFeatures,

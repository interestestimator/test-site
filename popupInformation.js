 ...
 */
export function showLoanInfo(event, loanLengthMonths, vehiclePrice, vehicleDeposit, annualRateTIN, commissionRate, pmt, annualRateTAE) {
    const getContent = () => `
        ${createPopupHeader('Offer details', 'finance')}
        <div class="finance-details-container">
            ${formatDetail("Cuota mensual*", formatCurrency(pmt))}
            ${formatDetail("Precio financiando", formatCurrency(vehiclePrice - vehicleDeposit))} 
        ...
        <div class="finance-conditions">
            ...
            <div class="legal-conditions">
                ...
                <p>***Precio al contado ${formatCurrency(vehiclePrice)}. Precio financiando ${formatCurrency(vehiclePrice)}...</p>
    ...
    const getContent = () => `
        ...
        <div class="bodytype-container">
            ...
            <ul>
                ...
                <li>
                    <h4>Dimensions</h4>
                    ${formatDetail("Length", `${currentCarData.length} mm`)}
                    ${formatDetail("Width", `${currentCarData.width} mm`)}
                    ${formatDetail("Height", `${currentCarData.height} mm`)}
                </li>
                <li>${formatDetail("Wheelbase", `${currentCarData.wheelbase} mm`)}</li>
            </ul>
        </div>
    `;

...
function adjustLoanInfo(loanLengthMonths, rawFinancePrice, vehicleDeposit, annualRateTIN, commissionRate, pmt, annualRateTAE) {
    ...
    const content = `
        <div class="container-title h3">Detalles de la oferta</div>
        <div>
        ...
        <div class="finance-conditions">
            <div class="b3">
                <span class="h3">Condiciones legales Adevinta</span>
                <p>
            ...
            <div class="b3">
                <span class="h3">Condiciones legales Santander Consumer Finance</span>
                <p>

...
function getPrimaryDOMElements() {
    return initializeDOMElements({ 
        ...
        footerSocials: 'footer-socials-container',              // ************* ADDED ///////////////////////
 ...
 * @returns {Object} An object containing references to primary DOM elements.
 */
function getContactUsDOMElements() {
    return initializeDOMElements({ 
        contactForm: 'company-contact-form',
    });
}
 ...
 * @returns {Object} An object containing references to primary DOM elements.
 */
function getCompanyDOMElements() {
    return initializeDOMElements({
        companyReviews: 'company-reviews-container'
    });
}
 ...
 * @returns {Object} An object containing references to primary DOM elements.
 */
function getSubscriptionDOMElements() {
    return initializeDOMElements({
        subscribeForm: 'company-subscription-form'
    });
}
...
function getCarDetailsDOMElements() { 
    return initializeDOMElements({ 
        ...
        resetValuesButton: 'resetValuesButton'
    });
}
...
export {
    ...
    getCompanyDOMElements, /// merge with getContactUsDOMElements

    getContactUsDOMElements,

...
function formatCarData(carData, isNewCar = false) {
    ...
    const pricingInfo = {
        raw: {
            current: rawPrice,
            previous: rawPreviousPrice,
            savings: rawPreviousPrice - rawPrice,
            financed: rawFinancePrice,
            financeSavings: rawPrice - rawFinancePrice,
        },
        formatted: {
            current: formatCurrencyValue(rawPrice),
            previous: formatCurrencyValue(rawPreviousPrice),
            savings: formatCurrencyValue(rawPreviousPrice - rawPrice),
            financed: formatCurrencyValue(rawFinancePrice),
    ...
    const bodyInfo = {
        ...
        doorCount: doors,
        seatCount: seats,
        weight: weight,      // Optionally keep this as is for clarity
        dimensions: {
            length,
            width,
            height,
    ...
    const formattedData = {
        ...
        bodyInfo,       ////////// PASS ALL FINANCE INFORMATION VIA THIS METHOD TO STREAMLINE ///////////////
        pricingInfo    ////////// PASS ALL FINANCE INFORMATION VIA THIS METHOD TO STREAMLINE ///////////////
    };

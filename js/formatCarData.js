...
function formatCarData(carData, isNewCar = false) {
    const {
        JavaScriptInfo: { 
            ...
            coloresExteriores: exteriorColours, // NEW VEHICLES ONLY // NEEDS TO BE IMPLIMENTED IN GALLERY COUNT
            coloresInteriores: interiorColours, // NEW VEHICLES ONLY // NEEDS TO BE IMPLIMENTED IN GALLERY COUNT

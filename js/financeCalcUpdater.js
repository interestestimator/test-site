...
function generateLoanContent({ formattedPmt, totalLoanAmount, deposit, loanTermMonths, installmentAmount, initialFeePercent, annualRateTIN, annualRateTAE, includeDocumentsButton, includeAcknowledgeButton }) {
    return ` 
        <div class="pt-sm ml-lg mr-lg b2">
        ...
        <div class="pt-sm ml-lg mr-lg b2">
            <h4 class="uppercase">Condiciones de financiación</h4>
            <span class="font-book">Condiciones legales Adevinta</span>
            <p class="font-book italic b3">
            ...
            <span class="font-book">Condiciones legales Santander Consumer Bank</span>
            <p class="font-book italic b3">
            ...
            <div class="pt-sm" style="width: 33%;margin-left: auto;">
                <button id="acknowledgeButton" class="rounded-container rounded-both bg-black b2 font-bold">Entendido</button>
            </div>` : ''}
        </div>
    `;
}

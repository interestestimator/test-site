    ...
    const getContent = () => `
        ...
        <div class="horsepower-container">
            ...
            <div id="carOverviewPopupContainer" class="details-container">
                ...
                ${formatDetailWithIcon("torque", `${currentCarData.torque} Nm`, "Par motor")}
                ${formatDetailWithIcon("cilindros", `${currentCarData.cylinders}`, "Cilindros")}
            </div>
            ...
            <ul class="contact-info">
                <li><strong>Teléfono:</strong> <span>(123) 456-7890</span></li>
                <li><strong>Dirección:</strong> <span>Calle Ejemplo 123, Ciudad, País</span></li>
            </ul>
        </div>
    `;
    ...
    const getContent = () => `
        ...
        <div class="horsepower-container">
            ...
            <div id="carOverviewPopupContainer" class="details-container">
                ...
                ${formatDetailWithIcon("dimensions-weight", `${currentCarData.weight} kg`, "Peso")}
 ...
 * @param {Object} currentCarData - The data object containing car specifications.
 */
export function showDiscountInfo(event, price, previousPrice, discountPercentage) {

    const getContent = () => `
        ${createPopupHeader('Detalles del Descuento', 'discount')}
        <div class="discount-container">
            <p>Here are the current and previous prices for this vehicle:</p>
            <ul>
                <li>${formatDetail("Previous Price", `$${previousPrice}`)}</li>
                <li>${formatDetail("Current Price", `$${price}`)}</li>
                <li>${formatDetail("You Save", `$savings ammount here (${discountPercentage}%)`)}</li>
            </ul>
        </div>
    `;

 ...
 * @param {boolean} isCarNew - Indicates if the car is new.
 */
function populateCarSections(elements, currentCarData, isCarNew) {
    ...
    // Call featuresContainer only if isCarNew is true
    if (isCarNew) {

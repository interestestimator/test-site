...
export function hideIndexPopups() {
...
export function showFilterOptions(event) {
    ...
    document.getElementById('closeFilterPopup').addEventListener('click', () => hidePopup('filterPopup'));
}
...
export function showSortOptions(event) {
    ...
    // Add event listeners to buttons
    document.getElementById('closeSortPopup').addEventListener('click', () => hidePopup('sortPopup'));
}

...
function createImageGallerySection(gallery, showTitle = false) {
    ...
    return `
        ...
        <div id="${gallery}ImageContainer" class="gallery-image-container b3">
            <img id="${gallery}Image" class="gallery-image" alt="${gallery} Image">
            <div class="nav-button-container">
                ${generateNavigationButtons(gallery)}
            </div>
            <label id="${gallery}PhotoCountLabel" class="label photo-count-label"></label>
        </div>
...
function generateNavigationButtons(gallery) {
    return `
        <button id="${gallery}PrevImage" class="nav-button font-bold" aria-label="Previous image">&lt;</button>
        <button id="${gallery}NextImage" class="nav-button font-bold" aria-label="Next image">&gt;</button>
    `;
}

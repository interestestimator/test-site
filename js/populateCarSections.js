    ...
    if (discountPercentage <= 0) {
        ...
        discountContainer.innerHTML = `
            <div class="sidebar__discount">
                <span class="show-discount-button rounded-container rounded-both bg-orange h3" style="width: 50%;">
                    ¡Te ahorras! ${discountPercentage}%
                </span>
            </div>
        `;
    ...
    financeSectionContainer.innerHTML = `
        ...
        <div class="bg-black">
            ...
            <div class="vehicle-price-result__action">
                ...
                <div id="testDriveBtn" class="btn round-xlg px-lg pblk-sm bg-accent center">

...
/**
 * Toggles the visibility of the overlay element, while toggling the opposite visibility for contactBannerTopContainer.
...
const toggleOverlay = (shouldShow) => {
    ...
    if (overlayElement) {
        ...
        // Toggle contactBannerTopContainer to the opposite of overlay visibility
        toggleElementVisibilityById('contactBannerTopContainer', !shouldShow);
    }
};
/**
...
const createPopupHeader = (title, idPrefix) => {
    ...
    return `
        <div class="popup-title flex jc-between px-lg pblk-md pt-lg b-sdw bg-white">
            <div class="${idPrefix}-text h4">${title}</div>
            <div id="close${idCapitalized}Popup" class="btn-inv flex">

 ...
 *
 * @param {number} price - The initial loan amount.
 ...
 * @param {number} annualRateTIN - The annual interest rate as a decimal.
 * @return {object} An object containing calculated results.
 */
function calculateRate(price, deposit, initialFeePercent, loanTermMonths, additionalRepaymentFee, annualRateTIN) {
    const totalLoanAmount = price - deposit;
...
/**
 * Sets the annual interest rate (TIN) and loan term based on vehicle price, year, and rawKilometres.
 *
 ...
 * @return {object} An object containing annualRateTIN, loanTermMonths, and initialFeePercent.
 */
function setLoanParameters(year, rawKilometres, price) {
